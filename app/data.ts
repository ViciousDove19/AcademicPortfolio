...
export const WORK_EXPERIENCE: WorkExperience[] = [
  {
    company: 'Health Informatics and Imaging Lab, IIT Madras',
    title: 'Project Research Scientist - 1',
    start: 'Oct 2025',
    end: 'Present',
  ...
  {
    company: 'Ather Energy, Bangalore, India',
  ...
  {
    company: 'iNSPIRE Lab, IITM, Chennai, India',
    title: 'Undergraduate Researcher',
    start: 'May 2021 – Dec 2021, Jul 2022',
    end: 'May 2023',
  ...
  {
    company: 'Samsung Research Institute, Bangalore, India',
